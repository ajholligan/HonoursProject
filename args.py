...
def get_args():
    ...
    parser.add_argument('--nworkers', default=0, type=int, help='number of data loading workers (default: 0)')
    ...
    parser.add_argument('--n_prototypes', default=50, type=int, help='Number of prototypes in the network architecture')
